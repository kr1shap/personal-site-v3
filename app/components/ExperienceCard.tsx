...
export default function ExperienceCard({
  ...
  return (
    ...
    >
      ...
      <div className="relative w-29 h-29 mt-5 rounded-full overflow-hidden shrink-0">
        <Image
      ...
      <div className="flex flex-col items-center gap-0 mt-2 text-center font-['Gamja_Flower',system-ui,sans-serif] whitespace-nowrap">
        ...
        <p className="text-[2.5rem] max-sm:text-[1.75rem] text-(--dull-grey) leading-tight m-0">
          {experience.role}
        </p>
        {/* Location | date — dull-blue, smallest */}
        <p className="text-[2rem] max-sm:text-[1.4rem] text-(--dull-blue) leading-snug mt-1 m-0">
